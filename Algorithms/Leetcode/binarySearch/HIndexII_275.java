...
public class HIndexII_275 {
	 ...
	 * case 3: citations[mid] < len-mid, we should continue searching in the right side After iteration, it
	 * is guaranteed that right+1 is the one we need to find (i.e. len-(right+1) papars have at least len-(righ+1) citations)
	 */
