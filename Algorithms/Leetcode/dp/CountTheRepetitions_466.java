...
public class CountTheRepetitions_466 {
	...
	/*
	 * 1, How do we know "string s2 can be obtained from string s1"? Easy, use two pointers iterate
	 * through s2 and s1. If chars are equal, move both. Otherwise only move pointer1. 
